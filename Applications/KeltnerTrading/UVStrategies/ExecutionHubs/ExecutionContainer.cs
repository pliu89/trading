...
namespace UV.Strategies.ExecutionHubs
{
    ...
    /// </summary>
    public class ExecutionContainer : IStringifiable, IEngineContainer
    {
        ...
        private bool m_IsLaunched = false;                          // flag is true after start has been called.
        //        
        // My Engines
        //
        ...
        private List<IEngine> m_IEngineList = new List<IEngine>();  // my IEngines (same as above)
        ...
        // *************************************************
        public bool ProcessEvent(EventArgs e)
        {
