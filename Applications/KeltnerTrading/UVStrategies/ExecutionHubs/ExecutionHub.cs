...
namespace UV.Strategies.ExecutionHubs
{
    ...
    public abstract class ExecutionHub : Hub, IService, IStringifiable, IEngineHub
    {
        ...
        private Dictionary<string, Dictionary<int, ExecutionContainer>> m_ExecutionContainers = new Dictionary<string, Dictionary<int, ExecutionContainer>>();
        ...
        private void CheckSpontaneousEngineEvents()
        {
            ...
            foreach(Dictionary<int,ExecutionContainer> execDict in m_ExecutionContainers.Values)
                foreach (ExecutionContainer execContainer in execDict.Values)
