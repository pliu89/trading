...
namespace UV.TTServices
{
    ...
    using UVOrderType = UV.Lib.OrderBookHubs.OrderType;
    using UVOrderTIF = UV.Lib.OrderBookHubs.OrderTIF;
    using UVOrderState = UV.Lib.OrderBookHubs.OrderState;
    using UVOrder = UV.Lib.OrderBookHubs.Order;

    using UV.TTServices.OrderBookHubs;
