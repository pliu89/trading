...
namespace Ambre.TTServices.Fills
{
    ...
    public class DropRulesOld
    {
        ...
        private Misty.Lib.IO.DropQueueWriter m_DropWriter = null;
        ...
        private List<Misty.Lib.OrderHubs.Fill> m_DropFillList = new List<Misty.Lib.OrderHubs.Fill>();   // workspace
        ...
        // ****                     Constructors                        ****
        // *****************************************************************
        public DropRulesOld(FillHub fillHub, Misty.Lib.IO.DropQueueWriter dropWriter)
        {
            m_FillHub = fillHub;
            Log = m_FillHub.Log;
        ...
        public bool LoadPositionFromDrop(string dropFilePathName, out DateTime localTimeLastFill)
        {
            ...
            Misty.Lib.IO.Xml.BackwardReader backReader = new Misty.Lib.IO.Xml.BackwardReader(dropFilePathName);
