...
namespace Ambre.TTServices.Fills
{
    ...
    /// </summary>
    public class FillBookLifo : IFillBook, IStringifiable
    {
        ...
        // *****************************************************************
        // Control parameters
        protected InstrumentName m_Name;
        protected double m_DollarPerPoint = 1.0;
        protected double m_SmallestFillPriceIncr = 0.01;
        protected string m_CurrencyName;
        protected double m_CurrencyRate = 1.0;
        ...
        protected List<Fill> m_FillsOpen = new List<Fill>(16);            // store for open fills that comprise our CURRENT position.
        protected List<Fill> m_FillTrail = new List<Fill>(128);           // all fills received this session.
        ...
        public string GetAttributes()
        {
            ...
            s.AppendFormat(" CurrencyName={0}", m_CurrencyName);
            return s.ToString();
