...
namespace Misty.Lib.BookHubs
{
    ...
    public abstract class BookHub : Hub
    {
        ...
        public BookHub(string name, string logDirectoryName, bool isShowLog)
            : base(name, logDirectoryName, isShowLog, LogLevel.ShowErrorMessages)
        {
            /*
        ...
        /// </summary>
        /// <param name="e">A list of market change events.</param>
        protected void ProcessBookEvents(List<EventArgs> eArgList)
        {
            ...
            List<int> updatedInstrList = ProcessBookEventsForABook(updateBookID, eArgList); // step 3            
            ...
            if (updatedInstrList.Count > 0) OnInstrumentChange(updatedInstrList);           // step 7.0
        }//end HubEventHandler().
        //
        //
        // ****             BringBookUpToDate()             ****
        ...
        /// <returns>a list of instrument IDs corresponding to which markets changed</returns>
        protected abstract List<int> ProcessBookEventsForABook(int bookID, List<EventArgs> eArgList);
        //
        //
        #endregion
        ...
        //
        /// <summary>
        /// Trigger the simplest event, "look at my book."
        /// </summary>
        /// <param name="changedInstruments">This list must be read only!</param>
        protected void OnInstrumentChange(List<int> changedInstruments)
        {
            if (changedInstruments != null) { OnInstrumentChange(changedInstruments, null); }
        }
        //
        /// <summary>
        /// Full method: Create a new event arg, trigger event.
        /// </summary>
        protected void OnInstrumentChange(List<int> changedInstruments, EventArgs customArgs)
        {
            //InstrumentChangeArgs eventArgs = new InstrumentChangeArgs(this, changedInstruments.ToArray());
            InstrumentChangeArgs eventArgs = new InstrumentChangeArgs(this, changedInstruments);
            if (customArgs != null && customArgs != EventArgs.Empty)
                eventArgs.SetCustomEvent(this, customArgs);
            // trigger the event now.
            if (this.InstrumentChanged != null) InstrumentChanged(this, eventArgs);
        }
        /// <summary>
        /// Basic - trigger event
        ...
        protected void OnInstrumentChange(InstrumentChangeArgs args)
        {
            ...
            if (this.InstrumentChanged != null) InstrumentChanged(this, args);
        }
        //
        //
        //
