...
namespace Misty.Lib.FrontEnds
{
    public static class ControlTools
    {
        ...
        /// <summary>
        /// Enable or disable a button on GUI thread.
        /// </summary>
        /// <param name="control"></param>
        /// <param name="isEnabled"></param>
        public static void SetButton(Control parentForm, ToolStripItem control, bool isEnabled)
        {
            if (control == null || control.IsDisposed)
                return;
            if (parentForm.InvokeRequired)
                parentForm.Invoke(new Action<ToolStripItem>((c) => c.Enabled = isEnabled), control);
            else
