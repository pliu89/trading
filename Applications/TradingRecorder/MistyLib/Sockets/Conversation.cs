...
namespace Misty.Lib.Sockets
{
	...
	public class Conversation
	{
		...
		// ****						Members						****
		//
		private volatile static int m_NextID = 0;
		...
		// ****                 Constructor                     ****
		// *********************************************************
		//public Conversation(TcpClient client, IPEndPoint ip, StartFunction s)
		public Conversation(TcpClient client, StartFunction s)
		{
			...
			m_StartFunction = s;
			this.Thread = new Thread(new ParameterizedThreadStart(m_StartFunction));
			m_ID = m_NextID;
			m_NextID++;
			this.Thread.Name = "Conversation " + m_ID.ToString();
		}
		//
		//
