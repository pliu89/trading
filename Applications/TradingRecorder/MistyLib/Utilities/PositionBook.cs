...
namespace Misty.Lib.Utilities
{
    public class PositionBook
    {
        ...
        public PositionBook(double smallestPriceIncrement, double dollarAmtOfSmallestPriceIncrement)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public PositionBook MakeCopy()
        {
            double[] weight = new double[1] { 1.0 };
            PositionBook[] book = new PositionBook[1] { this };
        ...
        public static PositionBook MakeNewCombinedBook(PositionBook[] book, double[] weight)
        {
            ...
            PositionBook newBook = new PositionBook(newTickSize, newDollarValuePerPoint);			// create new blank position book.
        ...
        public bool CombineBooks(PositionBook[] book, double[] weight)
        {
        ...
        ///		</param>
        public bool CombineBooks(PositionBook[] book, double[] weight, bool removeFillsFromBooks
        ...
        //
        //
        public bool CombineBooksAtSideandPrice(PositionBook[] book, double[] weight, bool removeFillsFromBooks
    , bool combineBestFillsFirst, double BuyPrice91, double SellPrice91)
        ...
        private double[] m_LastPriceBidAsk = null;
        private double m_LastMidPrice = 0.0;
        ...
        {
            if (m_LastPriceBidAsk != null)
            {
                m_LastPriceBidAsk = new double[activeMarketPrices.Length];
                for (int i = 0; i < activeMarketPrices.Length; ++i) { m_LastPriceBidAsk[i] = activeMarketPrices[i]; }
            }
            double gain = 0.0;
            if (TotalQty != 0)
            {
        ...
        public double UnrealizedDollarGains(double midPrices)
        {
            ...
            m_LastPriceBidAsk = null;                   // signals we should used midPrice by default.
        ...
        {
            if (m_LastPriceBidAsk != null)
                return UnrealizedDollarGains(m_LastPriceBidAsk);
            else
        ...
        public PositionBookEventArgs GetEventArgs()
        {
            ...
            eventArgs.EventType = PositionBookEventArgs.RequestType.CurrentState;
        ...
        public void ProcessEventArgs(PositionBookEventArgs eventArgs)
        {
            switch (eventArgs.EventType)
            {
                ...
                case PositionBookEventArgs.RequestType.Remove:
                    ...
                    break;
                case PositionBookEventArgs.RequestType.CurrentState:
                    this.ClearAll();
                    for (int i=0; i<eventArgs.PriceList.Count; ++i)
                    	this.Add(eventArgs.QtyList[i],eventArgs.PriceList[i]);
                	break;
        ...
        /// </summary>
        /// <param name="fillIndex">index (base 0) of the fill to be returned.</param>
