        ...
        */ 
        ...
        public static AppInfo GetInstance(string applicationName, bool isExactDirName)
        {
            ...
            if (string.IsNullOrEmpty(m_AppInfoInstance.ApplicationName))        // This gets set only on the first call.
            {
                ...
                string basePath = UV.Lib.IO.FilesIO.GetPathToDirName(System.IO.Directory.GetCurrentDirectory(), applicationName, isExactDirName);
                ...
                // Name this instance of application.
                //int id = System.Diagnostics.Process.GetCurrentProcess().Id;
                //string machineName = System.Environment.MachineName.ToLower();
                //m_AppInfoInstance.UniqueName = string.Format("{0}{1}{2}", machineName.Substring(0,1).ToUpper(),machineName.Substring(1), id);
