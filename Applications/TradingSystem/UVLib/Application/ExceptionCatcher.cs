...
namespace UV.Lib.Application
{
    ...
    public static class ExceptionCatcher
    {
        ...
        public static System.Windows.Forms.DialogResult QueryUserTakeAction(Exception exceptionThrown, UV.Lib.Hubs.Hub hub, string userMessage = null, EventArgs eventThatFailed = null)
        {
            ...
            if (hub != null)
            {
                hub.Log.NewEntry(UV.Lib.Hubs.LogLevel.Major, "ExceptionCatcher: {0}", msg.ToString());
                hub.Log.NewEntry(UV.Lib.Hubs.LogLevel.Major, "ExceptionCatcher: User chooses to {0}", result);
                if (result == System.Windows.Forms.DialogResult.Abort)
                {   // ABORT application
                    hub.Log.Flush();
                    UV.Lib.Application.AppInfo.GetInstance().RequestShutdown(hub, eventThatFailed);
                }
        ...
        /// <returns>>DialogResult selected by user.</returns>
        public static System.Windows.Forms.DialogResult QueryUserTakeAction(Exception exceptionThrown, UV.Lib.Hubs.Hub hub, EventArgs eventThatFailed)
        {
