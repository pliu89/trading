...
namespace UV.Lib.Fills
{
    public class Fill : IStringifiable , ICloneable
    {
        ...
        public static Fill Create(Fill fillToCopy)
        {
            ...
            newFill.InstrumentName = fillToCopy.InstrumentName;

            return newFill;
        }// Create()
        //
        public static Fill Create(int qty, double price, InstrumentName instrName, DateTime localTime, DateTime exchangeTime)
        {
            // copy each value to this.
            Fill newFill = new Fill();
            newFill.Qty = qty;
            newFill.InstrumentName = instrName;
            newFill.Price = price;
