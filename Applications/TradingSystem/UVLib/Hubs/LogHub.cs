...
namespace UV.Lib.Hubs
{
    ...
    public class LogHub : HubBase
    {
        ...
        // Message monitor
        //
        private FrontEnds.Utilities.GuiCreator m_GuiCreator = null;     // used to create a LogViewer
        ...
        // Working entry.
        //
        private object dictonaryLock = new object();
        ...
        public bool IsViewActive
        {
            ...
            set
            {
                ...
                if (m_LogViewer != null)
                {
                    ...
                    {   // view is active
                        m_LogViewer.AddMessage(String.Empty);
                        m_LogViewer.Invoke(new Action(() => { m_LogViewer.WindowState = System.Windows.Forms.FormWindowState.Normal; }));
                        //m_LogViewer.WindowState = System.Windows.Forms.FormWindowState.Normal;
                    }
                    else
                    {   // view is not active.
                        m_LogViewer.Invoke(new Action(() => { m_LogViewer.WindowState = System.Windows.Forms.FormWindowState.Minimized; }));
        ...
        private void Initialize()
        {
            ...
            TimeSpan offset;
            UV.Lib.Net.NistServices nist = null;
            bool isConnectToNIST = false;
            try
            {
                nist = UV.Lib.Net.NistServices.GetInstance(isConnectToNIST);
            }
            catch (Exception e)
            {
        ...
        private void CreateLogViewer()
        {
            ...
            {
                m_GuiCreator = FrontEnds.Utilities.GuiCreator.Create(typeof(LogViewer), this);
        ...
        private void GuiCreator_FormCreated(object sender, EventArgs eventArgs)
        {
            ...
            if (m_LogViewer == null)
            {
                FrontEnds.Utilities.GuiCreator.CreateFormEventArgs e = (FrontEnds.Utilities.GuiCreator.CreateFormEventArgs)eventArgs;
