    ...
    public class Node : IStringifiable
    {
        ...
        */
        ...
        public virtual void SetAttributes(Dictionary<string, string> attributes)
        {
            ...
            {
                if (a.Key.Equals("Name") && string.IsNullOrEmpty(this.Name))    // The first time this key comes up, its the nodes.
                    this.Name = a.Value;                                        // If its also an attribute of the sub element, thats okay.
                else
                    this.Attributes.Add(a.Key, a.Value);
            }
        }
