...
namespace UV.Lib.OrderBooks
{
    ...
    public class Order
    {
        ...
        public bool ChangesPending;                     // flag to signal wether this order has outstanding (in flight) changes.
        
        //
        // User-defined variables
        //
        public int UserDefinedTag = -1;                 // this field can be used for any Int the user would like to pass around with INTERNAL orders.
        ...
        //
        // pass through fields to API
        //
        public string Account;
        public OrderReason OrderReason;         // 15 char max for TT!

        //
        // Fields for special order types.
        //
        public int IStopPricePending;                       // Integerized stop price desired
        public int IStopPriceConfirmed;                     // Integerized stop price confirmed in market
        ...
        /// value, not yet confirmed by the market.
        /// </summary>
        public double StopPricePending
        {
            get { return IStopPricePending * TickSize; }
        }
        //
        /// <summary>
        /// Confirmed price of order.
        /// </summary>
        public double StopPriceConfirmed
        {
            get { return IStopPriceConfirmed * TickSize; }
        }
