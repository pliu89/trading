...
namespace UV.Lib.TaskHubs
{
    ...
    public class TaskEventArg : EventArgs, IStringifiable
    {
        ...
        public override string ToString()
        {
            ...
            if (this.Status == TaskStatus.ContinueWorking)
            {
        ...
        public string GetAttributes()
        {
            ...
            if (this.m_StartTime.CompareTo(DateTime.MinValue) != 0)
                s.AppendFormat("StartTime={0}", this.m_StartTime.ToString(UV.Lib.Utilities.Strings.FormatTime));
            if (this.StopTime.CompareTo(DateTime.MinValue) != 0)
                s.AppendFormat("StopTime={0}", this.StopTime.ToString(UV.Lib.Utilities.Strings.FormatTime));
