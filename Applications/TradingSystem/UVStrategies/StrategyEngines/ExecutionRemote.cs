...
namespace UV.Strategies.StrategyEngines
{
    ...
    public class ExecutionRemote : Engine
    {
        ...
        private Type m_ContainerType = typeof(UV.Strategies.ExecutionHubs.ExecutionContainers.ThreadContainer);
        ...
        public override void SetupBegin(IEngineHub myEngineHub, IEngineContainer engineContainer)
        {
            ...
            if (m_IsSubEngine == false)
            {
                ...
                e.DataObjectList.Add(m_ContainerType.ToString());           // 3 - Type of container to create for these engines.
        ...
        public override string GetAttributes()
        {
            ...
            s.AppendFormat(" ContainerType={0}", this.m_ContainerType);       
            return s.ToString();
        }
        public override void SetAttributes(Dictionary<string, string> attributes)
        {
            ...
            foreach (KeyValuePair<string,string> a in attributes)
            {
                ...
                else if(a.Key.Equals("ContainerType", StringComparison.OrdinalIgnoreCase))
                {
                    Type containerType = m_ContainerType.Assembly.GetType(a.Value);
                    if (containerType != null)  // we successfully parsed the string
