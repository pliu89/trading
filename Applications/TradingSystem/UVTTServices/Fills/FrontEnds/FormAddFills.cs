...
namespace UV.TTServices.Fills.FrontEnds
{
    ...
    public partial class FormAddFills : Form
    {
        ...
        // *****************************************************************
        //
        private UV.Lib.Hubs.LogHub Log = null;
        private UV.TTServices.Fills.FillHub m_FillHub = null;
        private UV.TTServices.Markets.MarketTTAPI m_Market = null;
        
        //private UV.Lib.Products.InstrumentBase m_CurrentInstrument = null;

        private UV.Lib.Products.InstrumentName m_CurrentInstrument = new UV.Lib.Products.InstrumentName();
        private UV.Lib.Products.InstrumentName m_EmptyInstrument = new UV.Lib.Products.InstrumentName();
        ...
        private void buttonDeleteBook_Click(object sender, EventArgs e)
        {
            ...
            {   // User has just confirmed the delete request.  
                ...
                if (Log != null)
                {
                    if (m_FillHub == null)
                    {
                        Log.NewEntry(UV.Lib.Hubs.LogLevel.Major,"FormAddFill.buttonDeleteBook_Click: FillHub is null!");
                        buttonDeleteBook.Text = ButtonDeleteBook_Normal;
                        return;
                    }
                    else if (m_CurrentInstrument == null || m_CurrentInstrument==m_EmptyInstrument)
                    {
                        Log.NewEntry(UV.Lib.Hubs.LogLevel.Major,"FormAddFill.buttonDeleteBook_Click: CurrentInsrument is null!");
                        buttonDeleteBook.Text = ButtonDeleteBook_Normal;
                        return;
                    }
                    //else if (m_CurrentInstrument.ForeignKey == null)
                    //{
                    //    Log.NewEntry(UV.Lib.Hubs.LogLevel.Major,"FormAddFill.buttonDeleteBook_Click: CurrentInsrument.ForeignKey is null!");
                    //    buttonDeleteBook.Text = ButtonDeleteBook_Normal;
                    //    return;
                    //}
                    Log.NewEntry(UV.Lib.Hubs.LogLevel.Major,"FormAddFill.buttonDeleteBook_Click: Request delete for {0} in FillHub {1}.",m_CurrentInstrument,m_FillHub.Name);
                }
                UV.Lib.OrderHubs.OrderHubRequest request = new UV.Lib.OrderHubs.OrderHubRequest(UV.Lib.OrderHubs.OrderHubRequest.RequestType.RequestDeleteBook);                
