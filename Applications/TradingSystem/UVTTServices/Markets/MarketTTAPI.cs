                    ...
                    {   // Process the start request
                        ...
                        {   // Database found. 
                            ...
                            foreach (UV.Lib.DatabaseReaderWriters.Queries.InstrumentInfoItem item in query.Results)
                            {
                                ...
                                string expiryCode = item.Expiry;
                                expiryCode = expiryCode.Trim();
                                ...
                                string seriesName = string.Format("{0}{1} - {2}", UV.Lib.Utilities.QTMath.GetMonthName(mo),yy,item.SpreadComposition);
                                // Create product                                
